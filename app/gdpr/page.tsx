                                                                                ...
                                                                                <Link href="/dashboard" className="text-green-400 hover:text-green-300 mb-8 inline-block">
                                                                                          {'<-'} Dashboard
                                                                                                          ...
                                                                                                          <h1 className="text-4xl font-bold mb-4">Mes droits RGPD</h1>
                                                                                                                  <p className="text-gray-400 mb-10">Gerez vos donnees personnelles conformement au reglement europeen RGPD.</p>
                                                                                                                                                ...
                                                                                                                                                <div className="flex items-center gap-3 mb-3">
                                                                                                                                                              <Download className="w-6 h-6 text-green-400" />
                                                                                                                                                                            <h2 className="font-semibold text-lg">Exporter mes donnees</h2>
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <p className="text-gray-400 text-sm mb-4">Telechargez toutes vos donnees au format JSON.</p>
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      <h2 className="font-semibold text-lg text-red-400">Supprimer mon compte</h2>
                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                              <div className="flex items-start gap-2 mb-4 text-yellow-400 text-sm">
                                                                                                                                                                                                                                                                                                                                            <AlertTriangle className="w-4 h-4 flex-shrink-0 mt-0.5" />
                                                                                                                                                                                                                                                                                                                                                          <p>Cette action est irreversible. Toutes vos donnees seront definitivement supprimees.</p>
                                                                                                                                                                                                                                                                                                                                                                      </div>
